...
class TopRatedCart extends Component {
  state = {apiStatus: apiStatusConstants.initial, topMovieList: []}
  ...
  renderSuccesView = () => {
    ...
    return <MoviesSlick moviesList={topMovieList} />
  }
